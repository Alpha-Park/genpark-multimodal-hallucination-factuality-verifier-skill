# genpark-multimodal-hallucination-factuality-verifier-skill
...
**genpark-multimodal-hallucination-factuality-verifier-skill** is a deterministic, zero-dependency Python skill engineered for enterprise AI agent governance, distributed observability, and guardrail enforcement pipelines.

> **Executive Capability**: Ground-truth factuality validator & contradiction detector (Cleanlab)
...
result = client.verify_factuality_consistency()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-multimodal-hallucination-factuality-verifier-skill": {
      "command": "python",
      "args": ["/path/to/genpark-multimodal-hallucination-factuality-verifier-skill/mcp_server.py"]
    }
  }
}
```
